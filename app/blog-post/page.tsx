    ...
    return (
        <div className="lg:h-95 lg:w-full xl:h-80 xl:w-full xx:h-109 xx:w-full bg-gray-lighter overflow-hidden">
            ...
            <div>
                ...
                <div className="relative lg:mt-5 lg:ml-20 lg:h-80 lg:w-62 bg-white rounded">
                    <Link href="/ad-history"><button className="relative text-dark lg:font-medium text-base lg:text-left lg:pt-5 lg:ml-6 cursor-pointer">Brand Flyer</button></Link>
                    <h3 className="relative text-light-blue lg:font-bold text-base lg:text-left lg:-mt-5 lg:ml-14">Blog Post</h3>
                    <Image src={line} alt="" className="relative lg:pt-1 lg:ml-14 lg:w-9.5 lg:h-1.5" />
                    ...
                    <div className="flex flex-wrap">
                        <div className="relative lg:mt-7 lg:ml-4 lg:h-33 lg:w-19.7 rounded border">
                            ...
                            <Image src={line} alt="" className="relative lg:mt-1 lg:pt-1.2 lg:ml-1.2 lg:w-19.3 lg:h-1.5" />
                            <h3 className="relative lg:ml-1.2 lg:mt-3 text-sm font-bold text-left">Title goes here</h3>
                            <h3 className="relative text-gray lg:ml-1.2 lg:mt-0.5 text-x font-bold text-left lg:max-w-19.5">description description
