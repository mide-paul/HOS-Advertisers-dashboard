    ...
    return (
        <div className="ss:h-71 sm:h-71 lg:h-60 lg:w-full xl:h-80 xl:w-full xx:h-109 xx:w-full bg-gray-lighter overflow-hidden">
            ...
            <div className="relative ss:ml-0 ss:mt-10 ss:w-21.5 ss:h-60 sm:ml-3 sm:mt-10 sm:w-21.5 sm:h-60 bg-white lg:ml-20 lg:mt-12 lg:w-62 lg:h-50 xl:ml-23 rounded">
                <div className="flex ss:gap-0.6 ss:pt-5 ss:ml-2 sm:gap-4 sm:pt-5 sm:ml-2 lg:gap-5 lg:pt-6 lg:ml-7">
                ...
                <div>
                    <div>
                        <Image src={settings_profile_image} alt="" className="relative ss:mt-6 ss:ml-2 sm:mt-6 sm:ml-2 size-11 lg:mt-8 lg:ml-7" />
                        <h3 className="relative ss:mt-5 ss:ml-2 sm:mt-5 sm:ml-2 text-dark text-sm font-semibold text-left lg:-mt-10 lg:ml-15.3">John Doe</h3>
                        ...
                        <h3 className="relative ss:mt-5 ss:ml-7 sm:mt-5 sm:ml-7 text-light-blue text-sm font-normal text-left lg:mt-6.5 lg:ml-10 cursor-pointer">
                            Edit Picture
                        </h3>
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-2 ss:ml-2 ss:mt-6 sm:ml-2 sm:mt-6 lg:ml-7 lg:mt-6">
                        ...
                        <input className="relative ss:h-6 ss:w-19.51 sm:h-6 sm:w-19.9 bg-gray-lighter lg:h-6 lg:w-20 text-sm p-2.5 rounded" placeholder="John Doe" />
                    </div>
                    <div className="flex flex-col gap-2 ss:ml-2 ss:mt-4 sm:ml-2 sm:mt-4 lg:ml-25 lg:-mt-8">
                        <label className="relative text-sm font-bold text-left text-dark">
                            Email Address
                        </label>
                        <input className="relative ss:h-6 ss:w-19.51 sm:h-6 sm:w-19.9 bg-gray-lighter lg:h-6 lg:w-20 text-sm p-2.5 rounded" placeholder="john@example.com" />
                    </div>
                    <div className="flex flex-col gap-2 ss:ml-2 ss:mt-4 sm:ml-2 sm:mt-4 lg:ml-7 lg:mt-6">
                        <label className="relative text-sm font-bold text-left text-dark">
                            UserName
                        </label>
                        <input className="relative ss:h-6 ss:w-19.51 sm:h-6 sm:w-19.9 bg-gray-lighter lg:h-6 lg:w-20 text-sm p-2.5 rounded" placeholder="JohnDoe" />
                    </div>
                    <div className="flex flex-col gap-2 ss:ml-2 ss:mt-4 sm:ml-2 sm:mt-4 lg:ml-25 lg:-mt-8">
                        <label className="relative text-sm font-bold text-left text-dark">
                            Phone Number
                        </label>
                        <input className="relative ss:h-6 ss:w-19.51 sm:h-6 sm:w-19.9 bg-gray-lighter lg:h-6 lg:w-20 text-sm p-2.5 rounded" placeholder="+1 80 222-344-89" />
                    </div>
                    <button className="relative ss:w-14 ss:h-6 ss:mt-5 ss:ml-2 sm:w-14 sm:h-6 sm:mt-5 sm:ml-2 bg-blue text-white text-sm lg:w-17 lg:h-6 lg:mt-6 lg:ml-7 rounded hover:bg-light-blue">Save Changes</button>
                </div>
            </div>
        </div>
    )
