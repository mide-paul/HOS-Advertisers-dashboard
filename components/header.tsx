...
export const Header = () => {
    ...
    return (
        <div className="fixed bg-white ss:h-8 ss:w-screen sm:h-8 sm:w-screen lg:h-11 lg:w-70 lg:ml-19.6 xl:w-95 z-20 xx:w-142">
            ...
            <div className="flex ss:gap-2 ss:-mt-8.5 ss:ml-15 sm:gap-3 lg:gap-5 sm:-mt-8.5 sm:ml-15.5 lg:ml-48 lg:-mt-6 items-center xl:ml-55 xx:ml-123">
                ...
                {/* <Image src={dropdown_icon} alt="" className="size-1 ss:invisible sm:invisible lg:visible xx:visible" /> */}
            </div>
        </div>
    )
}